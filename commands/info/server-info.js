...
**❯ ⏲️ เซิร์ฟเวอร์ถูกสร้างขึ้นเมื่อ:** <t:${String(guild.createdTimestamp).slice(0, 10)}:D> (<t:${String(guild.createdTimestamp).slice(0, 10)}:R>)
